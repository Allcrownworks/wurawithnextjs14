...
export default function Tax() {
  return (
      ...
      <main className="bg-green-800 p-6 overflow-y-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-teal-200 p-4 rounded-lg shadow-md sm:col-span-2 md:col-span-4">
            ...
            <p>
              ...
              laboriosam asperiores nulla deleniti dolores odio possimus unde
              voluptates eveniet obcaecati minus natus aperiam quae,
              exercitationem corporis esse, non laudantium maxime dicta?
              Aspernatur tempore fuga architecto vel deserunt veritatis atque
              porro illo obcaecati corrupti animi eveniet, a praesentium. Nisi,
              dolor cumque.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis
